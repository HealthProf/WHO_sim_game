...
export default function GuidePage() {
  return (
    <div className="flex max-w-3xl flex-col gap-[26px]">
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">The Session Loop, Step by Step</h2>
        <ol className="list-decimal list-inside space-y-2">
          <li>
            <b className="text-text">Start the simulation</b> from the Command Center. This starts the
          ...
          <li>
            <b className="text-text">Dispatch events</b> from the Command Center&apos;s Event Queue, grouped by
            simulated day. Clicking Dispatch opens a region picker — most events default to all six selected, but a
            few (marked <b className="text-accent-2-700">Targeted</b>, e.g. the SEARO data-sharing standoff) default to
          ...
          <li>
            <b className="text-text">Teams respond</b> on their own screens — you don&apos;t need to do
            anything while they&apos;re working, other than watch the Command Center&apos;s &quot;Needs Your
            Attention&quot; panel fill up.
          </li>
          <li>
            <b className="text-text">Score submissions</b> in the Scoring Inbox. It&apos;s sorted so the most
            urgent items are at the top: anything flagged <b className="text-accent-800">MANDATORY REVIEW</b> always
          ...
          <li>
            <b className="text-text">Watch the model update</b> — scoring a submission immediately applies
          ...
          <li>
            <b className="text-text">Push select events to the projector</b> — dispatching an event to teams
          ...
          <li>
            <b className="text-text">Pause any time</b> — pausing freezes the clock (both in-game and real
            elapsed time stop advancing) without closing any open submission windows. Resume picks up exactly where
            you left off.
          </li>
          <li>
            <b className="text-text">Close out</b> with Mark Complete when you&apos;re done — this is a soft,
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Other Controls Worth Knowing About</h2>
        <ul className="list-disc list-inside space-y-2">
          <li><b className="text-text">Action Log</b> — a full audit trail of every dispatch, score, override, and status change you&apos;ve made, with timestamps.</li>
          <li><b className="text-text">Deadlines enforce themselves</b> — HARD/SOFT deadlines auto-apply their fallback consequence tier when time runs out, even if you&apos;re not looking at the screen at that moment.</li>
          <li><b className="text-text">Passive drift</b> — regional Rt creeps upward slowly on its own whenever the sim is running and no fresh containment decision has landed for a while, so idle time between events isn&apos;t free.</li>
        </ul>
      </section>

      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Making Consequences Visible</h2>
        <ul className="list-disc list-inside space-y-2">
          <li><b className="text-text">Auto-push for big swings</b> — you no longer have to remember to click &quot;Push to Global Display&quot; for the dramatic moments. Any mandatory-review event, any Critical Failure, or any decision producing a large model swing pushes itself to the projector and drops a callout on the affected team&apos;s dashboard automatically.</li>
          <li><b className="text-text">Every scored decision gets a private card</b> — teams see a specific &quot;here&apos;s what just happened because of your choice&quot; notification on their dashboard (Recent Developments), not just numbers moving with no explanation.</li>
          <li><b className="text-text">Core path vs. optional events</b> — the Event Queue has a filter for the recommended ~60-minute spine (13 of the 16 events; the 3 marked Optional — MSF Open Letter, NPI Compliance Collapse, Political Interference — can be skipped without blocking anything downstream). Use it if you&apos;re running behind.</li>
          <li><b className="text-text">Per-team response checklist</b> — dispatched global/multi-region events show a chip per region so you can call out exactly who hasn&apos;t responded while circulating the room, instead of just a count.</li>
        </ul>
      </section>
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Deadlines, Targeted Events &amp; Popups</h2>
        <ul className="list-disc list-inside space-y-2">
          <li><b className="text-text">Active Deadlines panel</b> — the Command Center and the public display both show every currently-open countdown at once (not just whichever event you happen to be looking at), so you can track several concurrent timers across different events.</li>
          <li><b className="text-text">Targeted events</b> — EVT-002 (SEARO/WPRO/EURO) and the two adaptive events (EVT-009, EVT-013) are designed to go to a subset of regions, not everyone. Once every targeted region&apos;s decision is scored, the whole room automatically learns the outcome: a 10-second popup on the projector, and a popup on every team&apos;s dashboard that has to be closed with a button (not just a 10-second flash — a missed toast is easy to lose during a live session).</li>
          <li><b className="text-text">&quot;New event&quot; popups</b> — every dispatch also triggers a 10-second projector popup and a must-close popup on every targeted team&apos;s dashboard, so teams don&apos;t have to be staring at the Events page to notice something arrived.</li>
        </ul>
      </section>

      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Glossary &amp; Advisory Board</h2>
        <p>
          ...
          <b className="text-text">Advisory Board</b> — 3-4 diverse, sometimes-contradictory stakeholder
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Confidence Wager &amp; Resource Pledges</h2>
        <ul className="list-disc list-inside space-y-2">
          <li><b className="text-text">Confidence wager</b> — teams tag Low/Medium/High confidence alongside every decision. It&apos;s not scored on whether they were confident, only on calibration: High confidence paired with a good outcome earns a small bonus, High confidence paired with a bad outcome takes a bigger penalty, and Low confidence is never penalized either way. You&apos;ll see the raw score, the adjustment, and the final tier side by side on the scoring screen.</li>
          <li><b className="text-text">Resource pledges</b> — teams can pledge PPE, funds, antivirals, or HCW surge capacity directly to another region from the Pledges page. Unlike a rationale line, this actually moves the numbers between regions&apos; live ledgers, and shows up as a first-class artifact on the Debrief page.</li>
        </ul>
      </section>

      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Option Costs &amp; Affordability</h2>
        <p>
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Budget Cycle (every 14 narrative days)</h2>
        <p>
          A new pending cycle appears automatically on the Control page every 14 narrative days on the game clock.
          You get three options:
        </p>
        <ul className="list-disc list-inside space-y-2">
          <li><b className="text-text">Push Default to All</b> — silently disburses each region&apos;s standard increase (12% of its starting fund).</li>
          <li><b className="text-text">Adjust Amounts</b> — set a custom amount per region yourself, no team input.</li>
          <li><b className="text-text">Snap Decision</b> — every region gets a short window to accept the default or request more. If anyone requests more, a second window opens asking every <i>other</i> region whether they want to donate part of their own disbursement to the requester(s); donations are pooled and split proportionally across however many regions asked.</li>
        </ul>
      </section>

      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Marketplace (PPE &amp; Antivirals)</h2>
        <p>
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Emergency Funding</h2>
        <p>
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Redesigned Public Display</h2>
        <p>
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Debrief: Actual vs. Ideal Playthrough</h2>
        <p>
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Population Trust &amp; Happiness</h2>
        <p>
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Epidemic Growth Model (Recalibrated)</h2>
        <p>
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Live Dispatch Target Hints</h2>
        <p>
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Post-Scoring Reveal</h2>
        <p>
      ...
      <section className="space-y-3 rounded-lg bg-surface p-6 text-sm text-neutral-700">
        <h2 className="font-heading text-[21px] text-text">Social-Metric Consequence Arcs</h2>
        <p>
      ...
      <PillLink href="/control" tone="accent" className="self-start">
